...
# -------------------------------------------------------
OWNER_USERNAME = getenv("OWNER_USERNAME","abhi_9313")
# --------------------------------------------------------
BOT_USERNAME = getenv("BOT_USERNAME","Avika_musicbot")
# --------------------------------------------------------
...
LOGGER_ID = int(getenv("LOGGER_ID", -1001553892611))

# Get this value from @PURVI_HELP_BOT on Telegram by /id
OWNER_ID = int(getenv("OWNER_ID", 1714225411))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/ZORO7861/aJ/tree/main",
)
